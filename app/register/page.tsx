...
export default function RegisterPage() {
  ...
  return (
    <div className="max-w-md mx-auto py-12 px-4">
      ...
      <Tabs defaultValue="Email" onValueChange={(value) => setActiveTab(value as 'Email' | 'Phone')} className="mb-6">
        <TabsList className="bg-transparent border-b-2 border-border justify-center m-2">
